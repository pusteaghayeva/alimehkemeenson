...
class FromArtisanSpeechesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('speeches')->insert(array (
            0 => 
            array (
                'id' => 1,
                'title' => 'Çıxış 1',
                'slug' => 'cixis-1',
            'content' => '<p><span style="font-size: 14pt;"><a class="speech-link" style="box-sizing: border-box; color: black; text-decoration-line: none; margin: 0px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; text-align: justify;">Using color to add meaning only provides a visual indication, which will not be conveyed to users of assistive technologies &ndash; such as screen readers. Ensure that information denoted by the color is either obvious from the content itself (e.g. the visible text), or is included through alternative means, such as additional text hidden with the Using color to add meaning only provides a visual indication, which will not be conveyed to users of assistive technologies &ndash; such as screen readers. Ensure that information denoted by the color is either obvious from the content itself (e.g. the visible text), or is included through alternative means, such as additional text hidden with the class.</a></span></p>
...
<p><span style="font-size: 14pt;">Lorem</span></p>
<p><span style="font-size: 14pt;">Lorem</span></p>',
                'created_at' => '2022-05-05 17:14:00',
                'updated_at' => '2022-05-06 08:16:01',
            ),
            1 => 
            array (
                'id' => 2,
                'title' => 'Çıxış 2',
                'slug' => 'cixis-2',
                'content' => '<div id="Inner" style="margin: 0px auto; padding: 0px; width: 960px; color: #000000; font-family: \'Open Sans\', Arial, sans-serif; text-align: center;">
<div id="Content" style="margin: 0px; padding: 0px; position: relative;">
<div id="Translation" style="margin: 0px 28.7917px; padding: 0px; text-align: left;">
...
<p>&nbsp;</p>
                ...
                'created_at' => '2022-05-06 08:16:00',
                'updated_at' => '2022-05-06 08:21:02',
            ),
        ));
